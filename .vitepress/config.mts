      ...
      '/chatgpt/': [
        {
          ...
          items: [
            ...
            { text: 'MCP、A2A、Agentic RAG：2026年AI Agent协议生态全景解读', link: '/chatgpt/ai-agent-protocol-ecology-2026' },
            { text: 'MCP协议如何改变AI Agent的工作方式：从单机工具到生态联动的范式转变', link: '/chatgpt/mcp-agent-workflow-analysis-2026' },
            { text: 'OpenAI与AWS和解：Bedrock Managed Agents改变AI竞争格局', link: '/chatgpt/openai-aws-bedrock-managed-agents-2026' },
